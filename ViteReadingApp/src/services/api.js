...
export const getHighlights = (passage, question) => api.post('/gemini/highlight/', {passage, question});
...
export const checkAnswer = (questionId, answer) => api.post(`/questions/${questionId}/check_answer/`, { answer });
